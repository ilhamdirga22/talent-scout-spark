...
const Landing = () => {
  const features = [
    {
      ...
      description:
        "Advanced algorithms find the perfect candidates based on your specific requirements and company culture.",
      color: "bg-blue-500",
    },
    {
      icon: Target,
      ...
      description:
        "Filter across multiple platforms with surgical precision to find exactly who you're looking for.",
      color: "bg-purple-500",
    },
    {
      icon: Zap,
      ...
      description:
        "Get candidate recommendations in seconds, not days. Speed up your hiring process dramatically.",
      color: "bg-green-500",
    },
    {
      icon: MessageSquare,
      ...
      description:
        "Built-in messaging tools with AI-powered conversation suggestions and templates.",
      color: "bg-orange-500",
    },
  ];
  ...
  const testimonials = [
    ...
    },
    {
      ...
      company: "StartupXYZ",
      content:
        "The AI matching is incredibly accurate. It's like having a team of expert recruiters working 24/7.",
      rating: 5,
    },
    {
      name: "Emma Davis",
      ...
      company: "GrowthLab",
      content:
        "Game-changing platform. We've cut our time-to-hire by 75% while improving candidate quality.",
      rating: 5,
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left max-w-2xl">
              ...
              <p className="text-xl text-gray-600 mb-8">
                Transform your talent acquisition with intelligent matching. Our
                AI searches across LinkedIn, YouTube, and TikTok to discover
                exceptional candidates in seconds, not weeks.
              </p>
            ...
            {features.map((feature, index) => (
              ...
              >
                <CardHeader className="text-center pb-4">
                  <div
                    className={`w-16 h-16 rounded-2xl ${feature.color} p-4 mx-auto mb-4`}
                  >
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Simply tell our AI what kind of candidate you're looking for
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our intelligent algorithms search multiple platforms to find
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Review profiles, contact candidates directly, and make your
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center px-4 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of companies already using AI to find better
            candidates faster.
          </p>
          <Link to="/register">
            <Button
